...
const createUser = async (req, res) => { 
    ...
    try {
        ...
        const [result] = await pool.query('INSERT INTO users (fullname, username, password) VALUES (?, ?, ?)', [fullname, username, hashedPassword]); // Corrected 'hasedPassword' to 'hashedPassword'
